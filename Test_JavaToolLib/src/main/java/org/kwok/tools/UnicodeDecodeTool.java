...
public class UnicodeDecodeTool {
	...
	public static void main(String[] args) {
		...
		// cn.hutool:hutool-all 库，底层是调用 `UnicodeUtil.toUnicode()`。
		System.out.println(Convert.strToUnicode("中国"));
		...
		// cn.hutool:hutool-all 底层是调用 `UnicodeUtil.toString()`。
		System.out.println(Convert.unicodeToStr(unicodeStr));
